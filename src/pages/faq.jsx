...
function FAQCategory({ category, items }) {
  return (
    <div style={{ marginBottom: "40px" }}>
      <h2 style={{ marginBottom: "8px", fontSize: "18px" }}>{category}</h2>
      <div style={{ border: "1px solid var(--border)", borderRadius: "8px", padding: "0 20px" }}>
        {items.map((item, i) => (
  ...
  return (
    <div className={s.page}>
      <div className={s.pageHeader}>
        <span className={s.pageTag}>FAQ</span>
        <h1>❓ Frequently Asked Questions</h1>
        <p>Everything you'll wonder about SCRAPPER, answered.</p>
      </div>
      ...
      {filtered.length === 0 ? (
        <div className={`${s.callout} ${s.calloutWarning}`}>
          ...
          <div className={s.calloutBody}>
            ...
            <a href="https://github.com/BunElysiaReact/SCRAPY/issues" target="_blank" rel="noreferrer">
      ...
      <div className={`${s.callout} ${s.calloutInfo}`} style={{ marginTop: "16px" }}>
        <span className={s.calloutIcon}>💬</span>
        <div className={s.calloutBody}>
          Still stuck?{" "}
          <a href="https://github.com/BunElysiaReact/SCRAPY/issues" target="_blank" rel="noreferrer">
          ...
          — questions asked there may end up here.
        </div>
      </div>
